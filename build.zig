...
const tesseract_src_api: []const []const u8 = &.{ "src/api/altorenderer.cpp", "src/api/baseapi.cpp", "src/api/capi.cpp", "src/api/hocrrenderer.cpp", "src/api/lstmboxrenderer.cpp", "src/api/pagerenderer.cpp", "src/api/pdfrenderer.cpp", "src/api/renderer.cpp", "src/api/wordstrboxrenderer.cpp" };
const tesseract_src_arch: []const []const u8 = &.{ "src/arch/dotproduct.cpp", "src/arch/simddetect.cpp", "src/arch/intsimdmatrix.cpp" };
const tesseract_src_arch_avx: []const []const u8 = &.{"src/arch/dotproductavx.cpp"};
const tesseract_src_arch_avx2: []const []const u8 = &.{ "src/arch/intsimdmatrixavx2.cpp", "src/arch/dotproductavx.cpp" };
const tesseract_src_arch_avx512f: []const []const u8 = &.{"src/arch/dotproductavx512.cpp"};
const tesseract_src_arch_fma: []const []const u8 = &.{"src/arch/dotproductfma.cpp"};
const tesseract_src_arch_sse41: []const []const u8 = &.{ "src/arch/dotproductsse.cpp", "src/arch/intsimdmatrixsse.cpp" };
const tesseract_src_arch_neon: []const []const u8 = &.{ "src/arch/dotproductneon.cpp", "src/arch/intsimdmatrixneon.cpp" };
const tesseract_src_ccmain: []const []const u8 = &.{ "src/ccmain/adaptions.cpp", "src/ccmain/applybox.cpp", "src/ccmain/control.cpp", "src/ccmain/docqual.cpp", "src/ccmain/equationdetect.cpp", "src/ccmain/fixspace.cpp", "src/ccmain/fixxht.cpp", "src/ccmain/linerec.cpp", "src/ccmain/ltrresultiterator.cpp", "src/ccmain/mutableiterator.cpp", "src/ccmain/osdetect.cpp", "src/ccmain/output.cpp", "src/ccmain/pageiterator.cpp", "src/ccmain/pagesegmain.cpp", "src/ccmain/pagewalk.cpp", "src/ccmain/par_control.cpp", "src/ccmain/paragraphs.cpp", "src/ccmain/paramsd.cpp", "src/ccmain/pgedit.cpp", "src/ccmain/recogtraining.cpp", "src/ccmain/reject.cpp", "src/ccmain/resultiterator.cpp", "src/ccmain/superscript.cpp", "src/ccmain/tessbox.cpp", "src/ccmain/tessedit.cpp", "src/ccmain/tesseractclass.cpp", "src/ccmain/tessvars.cpp", "src/ccmain/tfacepp.cpp", "src/ccmain/thresholder.cpp", "src/ccmain/werdit.cpp" };
const tesseract_src_ccstruct: []const []const u8 = &.{ "src/ccstruct/blamer.cpp", "src/ccstruct/blobbox.cpp", "src/ccstruct/blobs.cpp", "src/ccstruct/blread.cpp", "src/ccstruct/boxread.cpp", "src/ccstruct/boxword.cpp", "src/ccstruct/ccstruct.cpp", "src/ccstruct/coutln.cpp", "src/ccstruct/detlinefit.cpp", "src/ccstruct/dppoint.cpp", "src/ccstruct/fontinfo.cpp", "src/ccstruct/image.cpp", "src/ccstruct/imagedata.cpp", "src/ccstruct/linlsq.cpp", "src/ccstruct/matrix.cpp", "src/ccstruct/mod128.cpp", "src/ccstruct/normalis.cpp", "src/ccstruct/ocrblock.cpp", "src/ccstruct/ocrpara.cpp", "src/ccstruct/ocrrow.cpp", "src/ccstruct/otsuthr.cpp", "src/ccstruct/pageres.cpp", "src/ccstruct/params_training_featdef.cpp", "src/ccstruct/pdblock.cpp", "src/ccstruct/points.cpp", "src/ccstruct/polyaprx.cpp", "src/ccstruct/polyblk.cpp", "src/ccstruct/quadlsq.cpp", "src/ccstruct/quspline.cpp", "src/ccstruct/ratngs.cpp", "src/ccstruct/rect.cpp", "src/ccstruct/rejctmap.cpp", "src/ccstruct/seam.cpp", "src/ccstruct/split.cpp", "src/ccstruct/statistc.cpp", "src/ccstruct/stepblob.cpp", "src/ccstruct/werd.cpp" };
const tesseract_src_ccutil: []const []const u8 = &.{ "src/ccutil/ambigs.cpp", "src/ccutil/bitvector.cpp", "src/ccutil/ccutil.cpp", "src/ccutil/errcode.cpp", "src/ccutil/indexmapbidi.cpp", "src/ccutil/params.cpp", "src/ccutil/scanutils.cpp", "src/ccutil/serialis.cpp", "src/ccutil/tessdatamanager.cpp", "src/ccutil/tprintf.cpp", "src/ccutil/unichar.cpp", "src/ccutil/unicharcompress.cpp", "src/ccutil/unicharmap.cpp", "src/ccutil/unicharset.cpp" };
const tesseract_src_classify: []const []const u8 = &.{ "src/classify/adaptive.cpp", "src/classify/adaptmatch.cpp", "src/classify/blobclass.cpp", "src/classify/classify.cpp", "src/classify/cluster.cpp", "src/classify/clusttool.cpp", "src/classify/cutoffs.cpp", "src/classify/featdefs.cpp", "src/classify/float2int.cpp", "src/classify/fpoint.cpp", "src/classify/intfeaturespace.cpp", "src/classify/intfx.cpp", "src/classify/intmatcher.cpp", "src/classify/intproto.cpp", "src/classify/kdtree.cpp", "src/classify/mf.cpp", "src/classify/mfoutline.cpp", "src/classify/mfx.cpp", "src/classify/normfeat.cpp", "src/classify/normmatch.cpp", "src/classify/ocrfeatures.cpp", "src/classify/outfeat.cpp", "src/classify/picofeat.cpp", "src/classify/protos.cpp", "src/classify/shapeclassifier.cpp", "src/classify/shapetable.cpp", "src/classify/tessclassifier.cpp", "src/classify/trainingsample.cpp" };
const tesseract_src_cutil: []const []const u8 = &.{"src/cutil/oldlist.cpp"};
const tesseract_src_dict: []const []const u8 = &.{ "src/dict/context.cpp", "src/dict/dawg.cpp", "src/dict/dawg_cache.cpp", "src/dict/dict.cpp", "src/dict/hyphen.cpp", "src/dict/permdawg.cpp", "src/dict/stopper.cpp", "src/dict/trie.cpp" };
const tesseract_src_lstm: []const []const u8 = &.{ "src/lstm/convolve.cpp", "src/lstm/fullyconnected.cpp", "src/lstm/functions.cpp", "src/lstm/input.cpp", "src/lstm/lstm.cpp", "src/lstm/lstmrecognizer.cpp", "src/lstm/maxpool.cpp", "src/lstm/network.cpp", "src/lstm/networkio.cpp", "src/lstm/parallel.cpp", "src/lstm/plumbing.cpp", "src/lstm/recodebeam.cpp", "src/lstm/reconfig.cpp", "src/lstm/reversed.cpp", "src/lstm/series.cpp", "src/lstm/stridemap.cpp", "src/lstm/weightmatrix.cpp" };
const tesseract_src_textord: []const []const u8 = &.{ "src/textord/alignedblob.cpp", "src/textord/baselinedetect.cpp", "src/textord/bbgrid.cpp", "src/textord/blkocc.cpp", "src/textord/blobgrid.cpp", "src/textord/ccnontextdetect.cpp", "src/textord/cjkpitch.cpp", "src/textord/colfind.cpp", "src/textord/colpartition.cpp", "src/textord/colpartitiongrid.cpp", "src/textord/colpartitionset.cpp", "src/textord/devanagari_processing.cpp", "src/textord/drawtord.cpp", "src/textord/edgblob.cpp", "src/textord/edgloop.cpp", "src/textord/equationdetectbase.cpp", "src/textord/fpchop.cpp", "src/textord/gap_map.cpp", "src/textord/imagefind.cpp", "src/textord/linefind.cpp", "src/textord/makerow.cpp", "src/textord/oldbasel.cpp", "src/textord/pithsync.cpp", "src/textord/pitsync1.cpp", "src/textord/scanedg.cpp", "src/textord/sortflts.cpp", "src/textord/strokewidth.cpp", "src/textord/tabfind.cpp", "src/textord/tablefind.cpp", "src/textord/tablerecog.cpp", "src/textord/tabvector.cpp", "src/textord/textlineprojection.cpp", "src/textord/textord.cpp", "src/textord/topitch.cpp", "src/textord/tordmain.cpp", "src/textord/tospace.cpp", "src/textord/tovars.cpp", "src/textord/underlin.cpp", "src/textord/wordseg.cpp", "src/textord/workingpartset.cpp" };
const tesseract_src_viewer: []const []const u8 = &.{ "src/viewer/scrollview.cpp", "src/viewer/svmnode.cpp", "src/viewer/svutil.cpp" };
const tesseract_src_wordrec: []const []const u8 = &.{ "src/wordrec/associate.cpp", "src/wordrec/chop.cpp", "src/wordrec/chopper.cpp", "src/wordrec/drawfx.cpp", "src/wordrec/findseam.cpp", "src/wordrec/gradechop.cpp", "src/wordrec/language_model.cpp", "src/wordrec/lm_consistency.cpp", "src/wordrec/lm_pain_points.cpp", "src/wordrec/lm_state.cpp", "src/wordrec/outlines.cpp", "src/wordrec/params_model.cpp", "src/wordrec/pieces.cpp", "src/wordrec/plotedges.cpp", "src/wordrec/render.cpp", "src/wordrec/segsearch.cpp", "src/wordrec/tface.cpp", "src/wordrec/wordclass.cpp", "src/wordrec/wordrec.cpp" };
const tesseract_src_legacy: []const []const u8 = &.{ "src/ccmain/adaptions.cpp", "src/ccmain/docqual.cpp", "src/ccmain/equationdetect.cpp", "src/ccmain/fixspace.cpp", "src/ccmain/fixxht.cpp", "src/ccmain/osdetect.cpp", "src/ccmain/par_control.cpp", "src/ccmain/recogtraining.cpp", "src/ccmain/superscript.cpp", "src/ccmain/tessbox.cpp", "src/ccmain/tfacepp.cpp", "src/ccstruct/fontinfo.cpp", "src/ccstruct/params_training_featdef.cpp", "src/ccutil/ambigs.cpp", "src/ccutil/bitvector.cpp", "src/ccutil/indexmapbidi.cpp", "src/classify/adaptive.cpp", "src/classify/adaptmatch.cpp", "src/classify/blobclass.cpp", "src/classify/cluster.cpp", "src/classify/clusttool.cpp", "src/classify/cutoffs.cpp", "src/classify/featdefs.cpp", "src/classify/float2int.cpp", "src/classify/fpoint.cpp", "src/classify/intfeaturespace.cpp", "src/classify/intfx.cpp", "src/classify/intmatcher.cpp", "src/classify/intproto.cpp", "src/classify/kdtree.cpp", "src/classify/mf.cpp", "src/classify/mfoutline.cpp", "src/classify/mfx.cpp", "src/classify/normfeat.cpp", "src/classify/normmatch.cpp", "src/classify/ocrfeatures.cpp", "src/classify/outfeat.cpp", "src/classify/picofeat.cpp", "src/classify/protos.cpp", "src/classify/shapeclassifier.cpp", "src/classify/shapetable.cpp", "src/classify/tessclassifier.cpp", "src/classify/trainingsample.cpp", "src/dict/permdawg.cpp", "src/dict/hyphen.cpp", "src/wordrec/associate.cpp", "src/wordrec/chop.cpp", "src/wordrec/chopper.cpp", "src/wordrec/drawfx.cpp", "src/wordrec/findseam.cpp", "src/wordrec/gradechop.cpp", "src/wordrec/language_model.cpp", "src/wordrec/lm_consistency.cpp", "src/wordrec/lm_pain_points.cpp", "src/wordrec/lm_state.cpp", "src/wordrec/outlines.cpp", "src/wordrec/params_model.cpp", "src/wordrec/pieces.cpp", "src/wordrec/plotedges.cpp", "src/wordrec/render.cpp", "src/wordrec/segsearch.cpp", "src/wordrec/wordclass.cpp" };
